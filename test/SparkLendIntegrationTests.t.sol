...
contract SparkLendConduitIntegrationTestBase is DssTest {
    ...
    function _assertInvariants() internal {
        ...
        assertApproxEqAbs(conduit.totalShares(DAI), aToken.scaledBalanceOf(address(conduit)), 2, "Invariant C");

        assertApproxEqAbs(conduit.getTotalDeposits(DAI), aToken.balanceOf(address(conduit)), 2, "Invariant D");
    }

    function _assertATokenState(uint256 scaledBalance, uint256 scaledTotalSupply, uint256 balance, uint256 totalSupply)
        internal
    {
    ...
    function _assertDaiState(uint256 buffer1Balance, uint256 buffer2Balance, uint256 aTokenBalance) internal {
...
contract SparkLendConduitDepositIntegrationTests is SparkLendConduitIntegrationTestBase {
    ...
    function test_deposit_singleIlk_valueAccrual() external {
        ...
        _assertDaiState({buffer1Balance: 100 ether, aTokenBalance: LIQUIDITY});
        ...
        _assertDaiState({buffer1Balance: 0, aTokenBalance: LIQUIDITY + 100 ether});
    ...
    function test_deposit_multiIlk_valueAccrual() external {
        ...
        _assertDaiState({buffer1Balance: 100 ether, buffer2Balance: 50 ether, aTokenBalance: LIQUIDITY});
        ...
        _assertDaiState({buffer1Balance: 0, buffer2Balance: 50 ether, aTokenBalance: LIQUIDITY + 100 ether});
        ...
        _assertDaiState({buffer1Balance: 0, buffer2Balance: 0, aTokenBalance: LIQUIDITY + 100 ether + 50 ether});
...
contract SparkLendConduitWithdrawIntegrationTests is SparkLendConduitIntegrationTestBase {
    ...
    function test_withdraw_singleIlk_valueAccrual() external {
        ...
        _assertDaiState({buffer1Balance: expectedValue - 2, aTokenBalance: LIQUIDITY + 100 ether - (expectedValue - 2)});
    ...
    function test_withdraw_multiIlk_valueAccrual() external {
        ...
        _assertDaiState({buffer1Balance: 0, buffer2Balance: 0, aTokenBalance: LIQUIDITY + 100 ether + 100 ether});
